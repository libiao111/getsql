...
<head>
    ...
    <link rel="stylesheet" href="/getsql2/Public/css/uikit.min.css" />
    <link rel="stylesheet" href="/getsql2/Public/css/font-awesome.min.css" />
    <link rel="stylesheet" href="/getsql2/Public/css/index.css" />
    <script src="/getsql2/Public/js/jquery.min.js"></script>
    <script src="/getsql2/Public/js/uikit.min.js"></script>
    <script src="/getsql2/Public/js/accordion.min.js"></script>
    <style type="text/css">
            ...
            <div class="uk-width-8-10">
                ...
                <?php if(is_array($table)): foreach($table as $key=>$v): ?><table class="uk-table uk-margin-bottom-remove" id="del_tab">
                        <tbody>
                            <tr>
                                <td width="80">
                                    <h3 class="uk-h3"><mark id="<?php echo ($v["id"]); ?>"><?php echo ($v["name_zh"]); echo ($v["name_en"]); ?></mark>
